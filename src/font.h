...
// Standard VGA 8x16 bitmap font for all 256 ASCII characters.
...
static const uint8_t vga_font[256][16] = {
    ...
    [0x03] = { 0x00,0x00,0x00,0x6C,0xFE,0xFE,0xFE,0xFE,0x7C,0x38,0x10,0x00,0x00,0x00,0x00,0x00 },
    ...
    [0x30] = { 0x00,0x00,0x7C,0xC6,0xC6,0xCE,0xD6,0xD6,0xE6,0xC6,0xC6,0x7C,0x00,0x00,0x00,0x00 },
    ...
    [0x7F] = { 0x00,0x00,0x00,0x10,0x38,0x6C,0xC6,0xC6,0xFE,0x00,0x00,0x00,0x00,0x00,0x00,0x00 },
    // 0x80-0xFF: extended/box-drawing chars, all blank for simplicity
